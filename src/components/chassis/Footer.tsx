...
export function Footer() {
  ...
  const featuredProjects = NAV_PROJECTS.slice(0, 4);
  const remainingProjects = NAV_PROJECTS.slice(4);

  return (
    <footer className="mx-xl flex flex-col gap-2xl rounded-card bg-ink p-lg">
