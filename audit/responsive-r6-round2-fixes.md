...
**375×667, top:**
  - `<div>` .ticker-track — width 2263px, overflow +1856px

**375×667, at rest:**
  - `<div>` .ticker-track — width 2263px, overflow +1844px

**393×852, top:**
  - `<div>` .ticker-track — width 2263px, overflow +1838px

**393×852, at rest:**
  - `<div>` .ticker-track — width 2263px, overflow +1826px

**430×932, top:**
  - `<div>` .ticker-track — width 2263px, overflow +1802px
...
**1024×1366, at rest:**
  - `<div>` .ticker-track — width 2749px, overflow +1683px

**1180×820, top:**
  - `<div>` .ticker-track — width 2749px, overflow +1541px

**1180×820, at rest:**
  - `<div>` .ticker-track — width 2749px, overflow +1527px
...
**375×667, top:**
  - `<div>` .ticker-track — width 3387px, overflow +2921px
...
**393×852, top:**
  - `<div>` .ticker-track — width 3387px, overflow +2907px
...
**393×852, at rest:**
  - `<div>` .ticker-track — width 3387px, overflow +2889px
  - `<div>` .flex — width 653px, overflow +810px
  - `<div>` .flex — width 653px, overflow +810px
  - `<div>` .flex — width 653px, overflow +810px
  - `<div>` .flex — width 653px, overflow +810px
...
**430×932, top:**
  - `<div>` .ticker-track — width 3387px, overflow +2871px
...
**430×932, at rest:**
  - `<div>` .ticker-track — width 3387px, overflow +2853px
  - `<div>` .flex — width 653px, overflow +773px
  - `<div>` .flex — width 653px, overflow +773px
  - `<div>` .flex — width 653px, overflow +773px
  - `<div>` .flex — width 653px, overflow +773px
...
**744×1133, top:**
  - `<div>` .ticker-track — width 4036px, overflow +3182px
...
**744×1133, at rest:**
  - `<div>` .ticker-track — width 4036px, overflow +3160px
  - `<div>` .flex — width 653px, overflow +459px
  - `<div>` .flex — width 653px, overflow +459px
  - `<div>` .flex — width 653px, overflow +459px
  - `<div>` .flex — width 653px, overflow +459px
...
**820×1180, top:**
  - `<div>` .ticker-track — width 4036px, overflow +3105px
...
**1024×1366, top:**
  - `<div>` .ticker-track — width 4036px, overflow +2909px
...
**1024×1366, at rest:**
  - `<div>` .ticker-track — width 4036px, overflow +2888px
  - `<div>` .flex — width 653px, overflow +189px
  - `<div>` .flex — width 653px, overflow +189px
  - `<div>` .flex — width 653px, overflow +189px
  - `<div>` .flex — width 653px, overflow +189px
...
**1366×1024, top:**
  - `<div>` .ticker-track — width 4036px, overflow +2567px

**1366×1024, at rest:**
  - `<div>` .ticker-track — width 4036px, overflow +2545px

**1440×900, top:**
  - `<div>` .ticker-track — width 4036px, overflow +2518px
