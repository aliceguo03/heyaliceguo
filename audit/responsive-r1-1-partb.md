...
**393×852, top:**
  - `<div>` .ticker-track — width 2263px, overflow +1835px
...
**820×1180, top:**
  - `<div>` .ticker-track — width 2749px, overflow +1880px
...
**1366×1024, top:**
  - `<div>` .ticker-track — width 2749px, overflow +1353px

**1366×1024, at rest:**
  - `<div>` .ticker-track — width 2749px, overflow +1338px
...
**375×667, top:**
  - `<div>` .ticker-track — width 3387px, overflow +2923px
...
**1180×820, top:**
  - `<div>` .ticker-track — width 4036px, overflow +2756px
...
**1180×820, at rest:**
  - `<div>` .ticker-track — width 4036px, overflow +2734px
  - `<div>` .flex — width 653px, overflow +33px
  - `<div>` .flex — width 653px, overflow +33px
  - `<div>` .flex — width 653px, overflow +33px
  - `<div>` .flex — width 653px, overflow +33px
...
**1366×1024, top:**
  - `<div>` .ticker-track — width 4036px, overflow +2572px
